...
static void imgui_set_loading_screen(void *state, bool active, const char *title, const char *subtitle, int progress_percent) { (void)state; (void)active; (void)title; (void)subtitle; (void)progress_percent; }
...
EditorBackendOps editor_backend_imgui_ops(void) {
    ...
    ops.set_loading_screen = imgui_set_loading_screen;
